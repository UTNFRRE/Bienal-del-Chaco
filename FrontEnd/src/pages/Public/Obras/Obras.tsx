import {Box, CardBody, Card, Heading, Text,  SimpleGrid, Flex, Button, IconButton, Divider} from '@chakra-ui/react';
                        ...
                        <CardBody borderRadius={10} w="100%" display="flex" flexDirection={"column"} h="auto" >
                          <Box position="relative" display="flex" justifyContent="center" alignItems="center" w="100%"  mb={4} >
                            <Box width="100%"  borderWidth={1} borderColor={"secundaryHover"}>
                              ...
                              />
                              {obra.tematica && (
                                    <Box position="absolute" bottom={0} left={0} bg="principal" color="white" p={1}>
                          ...
                          <Box w="100%" textAlign="left" display="flex" flexDirection={"column"} gap={0} onClick={() => handleCardClick(obra.esculturaId)}>
                            <Heading fontFamily={'Times New Roman'}>{obra.nombre}</Heading>
                            <Text as={"kbd"}>{obra.escultorNombre}</Text>
                            <Divider mt={1} mb={1} colorScheme={"black"} size={"2x1"}/>
                          </Box>
